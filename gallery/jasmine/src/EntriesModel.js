(function (global) {
    ...
    EntriesModel.prototype = {
        ...
        /**
         * Checks if row exists in the table data
         *
         * @returns {boolean} - true if row with specified ID exist in the table data
         */
        _isRowExist: function (id) {
           return this.dataObject.hasOwnProperty(id) ? true : false;
        },

        /**
         * Returns a row with specific ID
         *
         *@returns {Object} - a row data
         */
        getRowByID: function (id) {
            if (this._isRowExist(id)) {
